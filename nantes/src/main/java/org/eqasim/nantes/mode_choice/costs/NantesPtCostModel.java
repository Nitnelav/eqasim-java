...
public class NantesPtCostModel implements CostModel {
	...
	@Inject
	public NantesPtCostModel(NantesPersonPredictor personPredictor, NantesSpatialPredictor spatialPredictor,
	...
	private final static Coord CENTER = new Coord(355890.08, 6689461.43); // nantes castle
	...
	public double calculateCost_MU(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements) {
		...
		// TODO: Change that for Nantes !

		// II) If the trip is entirely inside of Paris, or it only consists of metro and
		// bus, the price is 1.80 EUR

		NantesSpatialVariables spatialVariables = spatialPredictor.predictVariables(person, trip, elements);
		boolean isWithinNantes = spatialVariables.hasUrbanOrigin && spatialVariables.hasUrbanDestination;

		boolean isOnlyMetroOrBus = isOnlyMetroOrBus(elements);

		if (isOnlyMetroOrBus || isWithinNantes) {
			return 1.8;
		}

		// TODO : implement a similar thing for Nantes ?
		/*-
