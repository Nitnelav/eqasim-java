...
public class NantesCarCostModel extends AbstractCostModel {
	private final NantesCostParameters costParameters;

	@Inject
	public NantesCarCostModel(NantesCostParameters costParameters) {
		super("car");
